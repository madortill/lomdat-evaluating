...
const papers = [
        ...
        content: [
            {
                ...
                text: (
                    <>
                        סגל המתמיינים <strong>ימנע מהעברת מידע</strong> על מערכות המיון, הערכות או ציונים של המתמיינים לכל גורם אחר שאינו מורשה לכך.
                    </>
                )
            },
            {
    ...
    },
    {
        ...
        cards: [
            ...
            "אחידות בהעברת הוראות התרגילים למועמדים - הקראת ההנחיות מתוך המיון."
        ],
