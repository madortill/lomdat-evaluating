...
const tabsData = [
    {
        ...
        items: [
            {
                icon: iconHouse,
                text: "יש לבצע את סידור החדר בצורה שתאפשר מעקב נוח אחרי כל אחד מהנבחנים במיון."
            },
            {
                icon: iconName,
    ...
    },
    {
        ...
        items: [
            ...
            "לשמור על רמת האנרגיה בקבוצה (השתתפות אקטיבית, נוכחות, עשייה וכו')."
        ]
    },
    {
        id: "observation",
        ...
        title: "תצפית",
        layout: "text",
        intro: "המעריך נדרש לתצפת ולרשום את תפקודם של המועמדים במהלך התרגיל בפרט ולאורך היום בכלל. \n תצפית והערכה - קווים מנחים:",
        items: [
            "שני מעריכים מעבירים את תרגילי המצב ורושמים בדף תצפית במהלך כל התרגילים.",
